...
if(P>0){
analogWrite(in1,0);
analogWrite(in2,constrain(abs(P+i-d),0,80));
analogWrite(in4,constrain(abs(P+i-d),0,80));
analogWrite(in3,0);}
else { 
analogWrite(in1,constrain(abs(P+i-d),0,80));
analogWrite(in2,0);
analogWrite(in4,0);
analogWrite(in3,constrain(abs(P+i-d),0,80));}  
